...
<style type="text/css">
	    .ebscohostCustomSearchBox {font-family:Helvetica,Verdana,Arial,sans-serif;width:300px;}
	...
	<form class="ebscohostCustomSearchBox" action="" onsubmit="return ebscoHostSearchGo(this);" method="post" style="overflow:hidden;">
		...
		<input id="ebscohosturl" name="ebscohosturl" type="hidden" value="http://search.ebscohost.com/login.aspx?direct=true&scope=site&type=1&site=ehost-live&db=bch&db=8gh&db=lxh&db=krh&db=bwh&db=trh&lang=en&authtype=ip,uid" />
		<input id="ebscohostsearchsrc" name="ebscohostsearchsrc" type="hidden" value="url" />
		<input id="ebscohostsearchmode" name="ebscohostsearchmode" type="hidden" value="+" />
		<input id="ebscohostkeywords" name="ebscohostkeywords" type="hidden" value="" />
		
		<div style="background-image:url('https://support.ebscohost.com/images/logos/researchdatabases.gif'); background-repeat:no-repeat; height:70px; width:300px; font-size:9pt; color:#353535;">
			<div style="padding-top:5px;padding-left:75px;">
				...
				<div>
					...
					<input type="submit" value="Search" class="ebscohost-search-button " style="font-size:9pt;padding-left:5px;" />
					 <div><a href="https://search.ebscohost.com/login.aspx?authtype=ip,uid&custid=ns213435&groupid=main&profile=bsc" target=_blank>Browse: BSC Publications</a>
				</div>
			</div>
		</div>
